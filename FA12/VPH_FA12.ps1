...
$url = "https://kaglav.sharepoint.com/:u:/s/IT/IQAqlSvn1Oz8RLb16wst7h5fAQcxeSQ0a79-UMxedCIYVoU?e=zcUJyM&download=1"  # Thay thế bằng đường dẫn thực tế đến file VPH_FA12.Zip +"&download=1" 

# Đường dẫn lưu file zip và thư mục đích
$zipPath = "C:\FAST\VPH_FA12.Zip"
$extractPath = "C:\FAST"
...
# Bước 2: Giải nén file VPH_FA12.Zip vào C:\FAST
...
$shortcutName = "VPH_FA12.lnk"  # Thay thế bằng tên shortcut thực tế trong file nén
