...
$url = "https://kaglav.sharepoint.com/:u:/s/IT/IQBrzI6JFpKOSLKiyoAU7p_WAeHtQk83_DI3_MAlU7LO-Pk?e=UUxLp0&download=1"  # Thay thế bằng đường dẫn thực tế đến file KTC_FA12.Zip +"&download=1" 

# Đường dẫn lưu file zip và thư mục đích
$zipPath = "C:\FAST\KTC_FA12.Zip"
$extractPath = "C:\FAST"
...
# Bước 2: Giải nén file KTC_FA12.Zip vào C:\FAST
...
$shortcutName = "KTC_FA12.lnk"  # Thay thế bằng tên shortcut thực tế trong file nén
