...
$url = "https://kaglav.sharepoint.com/:u:/s/IT/IQAN0ik76dI-SqYBsqIPMm8iAd93bFHRaCtwzvgPnF6AIH4?e=Z6UHDa&download=1"  # Thay thế bằng đường dẫn thực tế đến file KAK_FA12.Zip +"&download=1" 

# Đường dẫn lưu file zip và thư mục đích
$zipPath = "C:\FAST\KAK_FA12.Zip"
$extractPath = "C:\FAST"
...
# Bước 2: Giải nén file KAK_FA12.Zip vào C:\FAST
...
$shortcutName = "KAK_FA12.lnk"  # Thay thế bằng tên shortcut thực tế trong file nén
