...
$url = "https://kaglav.sharepoint.com/:u:/s/IT/IQDQ0ws_CBGUQbcRxZduGsW9AYLct7GNQVQXyZr56nO35tA?e=hL4Cgq&download=1"  # Thay thế bằng đường dẫn thực tế đến file KIA_FA12.Zip +"&download=1" 

# Đường dẫn lưu file zip và thư mục đích
$zipPath = "C:\FAST\KAY_FA12.Zip"
$extractPath = "C:\FAST"
...
$shortcutName = "KAY_FA12.lnk"  # Thay thế bằng tên shortcut thực tế trong file nén
